...
### - Fichier d'origine : ../plugins/auto/revisions/plugin.xml
...
# svn add lang/paquet-revisions_fr.php
...
# svn mv base/revisions_upgrade.php revisions_administrations.php
